		...
		<div class="row-fluid inline">
			<div class="pull-left">
				...
				<div  class="pull-right">
					...
					<div  class="pull-left">	
					<?php 
						echo JHTML::_('calendar', $this->date['start_date'], 'start_date', 'start_date', '%Y-%m-%d 00:00:00', array('class'=>'inputbox','placeholder'=>'startdate'));
					?>			
					</div>
					<div  class="pull-left">	
					<?php 
						echo JHTML::_('calendar', $this->date['end_date'], 'end_date', 'end_date', '%Y-%m-%d 00:00:00', array('class'=>'inputbox','placeholder'=>'enddate'));
					?>		
					</div>	
	...
	<table class="<?php echo $tblclass; ?>" width="100%">
		...
		<?php endif;?>	
			<tr>
				...
				<th width="9%"><?php echo JHtml::_( 'grid.sort', 'COM_JGIVE_ID','id', $this->lists['filter_order_Dir'], $this->lists['filter_order']); ?></th>			
			</tr>
	</thead>
			<?php
			if(!empty($this->data))
		...
		<input type="hidden" name="layout" value="ending_camp" />
