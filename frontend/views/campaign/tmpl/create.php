...
$terms_cond=$params->get('terms_condition');
...
<script type="text/javascript">
	...
	function addClone(rId,rClass)
	{
		...
		removeButton+="<button class='btn btn-mini btn-primary' type='button' id='remove"+num+"'";
	...
	*/
	...
	function showTab(value)
	{
		...
		if(value=='last')
		{
			techjoomla.jQuery('#steps').text(steps_count+lang_const_of+' '+steps_count);
			techjoomla.jQuery('#jgive-progressbar').css('width','100%');
			techjoomla.jQuery('#tab'+tabId+'fb').hide();
			techjoomla.jQuery('#tab4fb').show();
			techjoomla.jQuery('#active'+tabId).removeClass('active');
			techjoomla.jQuery('#active4').addClass('active');
			tabId=4;
		...
		{
			techjoomla.jQuery('#steps').text('1 '+lang_const_of+' '+steps_count);
			techjoomla.jQuery('#jgive-progressbar').css('width','16%');
			techjoomla.jQuery('#tab'+tabId+'fb').hide();
			techjoomla.jQuery('#tab1fb').show();
			techjoomla.jQuery('#active'+tabId).removeClass('active');
			techjoomla.jQuery('#active1').addClass('active');
			tabId=1;
			techjoomla.jQuery('#next-btn').show();
			techjoomla.jQuery('#last-btn').show();
		}
		//alert(tabId);
		else if(value=='next')
		{
			if(isGivebackHidden && tabId==2)
			{
						techjoomla.jQuery('#steps').text('3 '+lang_const_of+' 3');
						tabId=tabId+1;
						techjoomla.jQuery('#jgive-progressbar').css('width','68%');
						techjoomla.jQuery('#tab2fb').hide();
						techjoomla.jQuery('#tab3fb').show();
						techjoomla.jQuery('#active2').removeClass('active');
						techjoomla.jQuery('#active3').addClass('active');



						tabId=tabId+1;
						techjoomla.jQuery('#jgive-progressbar').css('width','100%');
						techjoomla.jQuery('#tab3fb').hide();
						techjoomla.jQuery('#tab4fb').show();
						techjoomla.jQuery('#active3').removeClass('active');
						techjoomla.jQuery('#active4').addClass('active');
						//hide next & last btn
						techjoomla.jQuery('#next-btn').hide();
						techjoomla.jQuery('#last-btn').hide();
			...
			else
			{
				...
				{
					case 1:
						techjoomla.jQuery('#steps').text('2 '+lang_const_of+' '+steps_count);
						tabId=tabId+1;
						techjoomla.jQuery('#jgive-progressbar').css('width','34%');
						techjoomla.jQuery('#tab1fb').hide();
						techjoomla.jQuery('#tab2fb').show();
						techjoomla.jQuery('#active1').removeClass('active');
						techjoomla.jQuery('#active2').addClass('active');
					break;

					case 2:
						techjoomla.jQuery('#steps').text('3 '+lang_const_of+' '+steps_count);
						tabId=tabId+1;
						techjoomla.jQuery('#jgive-progressbar').css('width','68%');
						techjoomla.jQuery('#tab2fb').hide();
						techjoomla.jQuery('#tab3fb').show();
		...
		else if(value=='previous')
		{
			...
			if(isGivebackHidden && tabId==4)
			{
					...
					techjoomla.jQuery('#jgive-progressbar').css('width','68%');
					tabId=tabId-1;
					techjoomla.jQuery('#tab4fb').hide();
					techjoomla.jQuery('#tab3fb').show();
					techjoomla.jQuery('#active4').removeClass('active');
					techjoomla.jQuery('#active3').addClass('active');
	...
	function tabClick(value)
	{
		...
		{
			case 1:
				jQuery('#steps').text('1 '+lang_const_of+' '+steps_count);
			...
			case 2:
				jQuery('#steps').text('2 '+lang_const_of+' '+steps_count);
			...
			case 3:
				jQuery('#steps').text('3 '+lang_const_of+' '+steps_count);
			...
			case 4:
				jQuery('#steps').text(steps_count+' '+lang_const_of+' '+steps_count);
	...
	<div class="">
		...
		<div class="">
			...
			class="form-horizontal form-validate" onsubmit="return validateForm();">
				<div class="">
					<div class="navbar-inner jgive-novbar-background">
						<div class="" id="tabContainer">
							<ul class="nav nav-pills " id="myTab ">
								...
								<li id="active4" onclick="tabClick('4')"><a data-toggle="tab" href="#tab4fb"><?php echo JText::_('COM_JGIVE_IMG_GALLERY');?></a></li>
							</ul>
							<div  id="steps" class="number-page pull-right jgive_steps"><b>1 <?php echo JText::_('COM_JGIVE_STEPS'); ?>
							<?php
								if($show_field==1 OR $give_back_cnf==0)
								{
									echo 4;
							...
							<div class="">
								<fieldset>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" id="title" name="title" class="required" maxlength="250" placeholder="<?php echo JText::_('COM_JGIVE_TITLE_PH');?>"
									...
									<div class="control-group">
										...
										<div class="controls">
											<div class="input-append">
												<input type="text" id="goal_amount" name="goal_amount" class="required validate-numeric" maxlength="11"
								...
								<?php if($show_field==1 OR $min_donation_cnf==0 ): ?>
									<div class="control-group">
										...
										<div class="controls">
											<div class="input-append">
												<input type="text" id="minimum_amount" name="minimum_amount" class="required validate-numeric" maxlength="11"
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php
												...
												{
													//$cdata['campaign']=new Stdclass; // Do not remove comment otherewise profile import will not work
								...
								<!--rearange  -->
									...
									if(!$this->admin_approval)
									{
										...
										?>
										<div class="control-group">
											<label class="control-label" title="<?php echo JText::_('COM_JGIVE_PUBLISH_TOOLTIP');?>">
...
<!--Condition changed by Sneha-->
								<?php if($show_field==1 OR ($allow_exceed_cnf==0 AND $goal_amount==0 )): ?>
									...
									?>
									<div class="control-group">
										<label class="control-label" title="<?php echo JText::_('COM_JGIVE_ALLOW_DONATIONS_EXCEED_TOOLTIP');?>">
								...
								<?php if($show_field==1 OR $show_public_cnf==0 ): ?>
									...
									?>
									<div class="control-group">
										<label class="control-label" title="<?php echo JText::_('COM_JGIVE_SHOW_DONATIONS_TO_TOOLTIP');?>">
								...
								$integration=$params->get('integration');
								 ...
								 if($show_field==1 OR $js_group==0 ):
									...
									if($count>=1) { ?>
									<div class="control-group">
										<label class="control-label" for="type" title="<?php echo JText::_('COM_JGIVE_SELECT_GROUP_TP');?>">
							...
							<div class="">
								...
								<?php if($show_field==1 OR $phone_cnf==0 ): ?>
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" id="phone" name="phone" class="required" placeholder="<?php echo JText::_('COM_JGIVE_PHONE_PH');?>"
												...
												if(isset($cdata['givebacks']))//for edit - recreate giveback blocks
												{
													...
													?>
														<div id="jgive_container<?php echo $i;?>" class="jgive_container">
															<div class="com_jgive_repeating_block span10" >
																<div class="control-group">
															...
															<!-- Added by Sneha -->
																...
																<div class="control-group">
																	<label class="control-label" for="coupon_image"><?php echo JText::_('COM_JGIVE_GIVEBACK_IMAGE');?></label>
																		<div class="controls">
																			...
																			if(isset($cdata['givebacks']) && count($cdata['givebacks']))
																			{
																				...
																				<div>
																					...
																					//foreach($cdata['images'] as $img){		//print_r($cdata['images']);
																						echo "<img class='img-rounded com_jgive_img_128_128' src='".JUri::base().$giveback->image_path."' />";
																					//}
																					?>
																				</div>
																				<?php
															...
															<div class='com_jgive_remove_button span2'>
													...
													<div class="control-group">
														...
														<div class="controls">
															 <div class="input-prepend input-append">
																...
																<input type="text" class="give_back_value" id="give_back_value" name="give_back_value[]"
																onblur='validateAmount(id,"<?php echo JText::_('COM_JGIVE_INVALID_GIV_VALUE'); ?>")'
						...
						<div class="row-fluid">
							<div class="">
								<fieldset>
									...
									<div class="control-group">
										<label class="control-label" for="video_url" title="<?php echo JText::_('COM_JGIVE_VIDEO_URL_TOOLTIP');?>">
									...
									<div class="control-group imagediv" id="imagediv">
										<label for="avatar" class="control-label"><?php echo JHTML::tooltip(JText::_('COM_JGIVE_PROD_IMG_TOOLTIP'), JText::_('COM_JGIVE_PROD_IMG'), '',JText::_('COM_JGIVE_PROD_IMG'));?></label>
										<div class="controls">
											<?php
									...
									{
										$link='';
										if($params->get('camp_create_terms_article'))
											$link = JRoute::_(JUri::root()."index.php?option=com_content&view=article&id=".$params->get('camp_create_terms_article')."&tmpl=component" );
										if($link)
										{
										?>
										<div class="control-group">
				...
				<div class="section-content footer">
					<ul class="nav nav-pills pager">
						...
						<li id="first-btn">
							<button class="previous first btn" type="button" onclick="showTab('first')" >
								<i class="icon-fast-backward "></i>&nbsp;<?php echo JText::_('COM_JGIVE_FIRST_BTN'); ?>
							</button>&nbsp;
						</li>

						<li id="previous-btn">

							<button class="previous first btn" type="button" onclick="showTab('previous')" >
								<i class="icon-step-backward "></i>&nbsp;<?php echo JText::_('COM_JGIVE_PRE_BTN'); ?>
							</button>&nbsp;

						</li>

						<li id="last-btn" class="pull-right" >
							<button class="last btn" type="button" onclick="showTab('last')" >
								<?php echo JText::_('COM_JGIVE_LAST_BTN'); ?>&nbsp;<i class="icon-fast-forward "></i>
							</button>&nbsp;
						</li>

						<li id="next-btn" class="pull-right" >
							<button class="next btn" type="button" onclick="showTab('next')" >
								<?php echo JText::_('COM_JGIVE_NEXT_BTN'); ?>&nbsp;<i class="icon-step-forward "></i>
							</button>&nbsp;
						</li>

						<li id="submit-btn" class="pull-right " style="display: none;">
							<button class="btn btn-success validate com_jgive_button" type="" ><?php echo JText::_('COM_JGIVE_BUTTON_SAVE_CAMPAIGN'); ?></button>
						</li>
						...
						<li id="cancel-btn" class="pull-right" style="display: none;">
							<button class="btn com_jgive_button" type="button" onclick="cancel()" ><?php echo JText::_('COM_JGIVE_CANCEL');?></button>
						</li>
					</ul>
					<!-- // Action -->
				</div>
